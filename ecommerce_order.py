...
using langchain-compensation with the following features:
...
from langchain_compensation import create_comp_agent, CompensationSchema
...
compensation_logger = logging.getLogger("langchain_compensation.middleware")
...
os.environ.setdefault("LANGSMITH_PROJECT", os.getenv("LANGSMITH_PROJECT", "langchain-compensation-examples"))
...
def main():
    ...
    print("\nE-commerce Order Processing with Automatic Compensation")
    print("Using langchain-compensation v0.4.0\n")
