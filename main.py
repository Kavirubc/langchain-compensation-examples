"""LangChain Compensation demonstration scenarios.

This module demonstrates the langchain-compensation middleware with:
...
from agents import OrderProcessorAgent, OrderRequest, TravelCoordinator, TripRequest
...
def main() -> int:
    ...
    try:
        ...
        logger.info("langchain_compensation_demo version=0.4.0")
