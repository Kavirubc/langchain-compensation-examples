...
from strategies.error_detection import BookingErrorStrategy
...
class TravelCoordinator:
    ...
    Features:
    - Shared CompensationLog across agents
...
Provide the hotel confirmation details after booking."""
    ...
    def __init__(self, config: Config):
        ...
        """
        self._config = config
        self._shared_log = CompensationLog()
    ...
    def _build_hotel_agent(self):
        ...
        return create_comp_agent(
            ...
            compensation_mapping=compensation_mapping,
            compensation_schemas=compensation_schemas,
            error_strategies=[BookingErrorStrategy()],
            shared_log=self._shared_log,
